  ...
  return (
    <>
      <main>
        ...
        <article className="info">
          <section>
            <header>
              <h1>
                HI, I'M <span className="secondary">ADAM FLETT</span>
              </h1>
              <h2>
                WEB DEVELOPMENT <span className="secondary">AND</span> DESIGN
              </h2>
              <p>
                Motivated designer and developer with experience creating custom
                websites with various web technologies. Strong collaboration
                skills and proven history of application development. Client
                first approach with an emphasis on communication.
              </p>
            </header>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              serve your organization and establish an enjoyable career for
              myself.
            </p>
          </section>
          ...
          <section>
            ...
            <a href="adam-flett-web.pdf" className="resume">
              DOWNLOAD RESUME
            </a>
          </section>
          ...
          <section className="social">
            ...
            <a href="https://github.com/abflett/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon"
                viewBox="0 0 24 24"
            ...
            <a href="mailto:adam@adamflett.net?Subject=Hello" target="_top">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon"
                viewBox="0 0 24 24"
      ...
      <footer>
        ...
        <p>
          Made with <span className="heart">❤</span> by Adam Flett
        </p>
      </footer>
    </>
  );
